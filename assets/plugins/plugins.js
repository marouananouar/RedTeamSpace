...
var Typer = function(a) {
    ...
    this.words = c.split(b).filter(a => a), this.delay = a.dataset.delay || 200, this.loop = a.dataset.loop || "true", "false" === this.loop && (this.loop = 1), this.deleteDelay = a.dataset.deletedelay || a.dataset.deleteDelay || 800, this.progress = {
        word: 0,
        char: 0,
        building: !0,
        looped: 0
...
var Cursor = function(a) {
    this.element = a, this.cursorDisplay = a.dataset.cursordisplay || a.dataset.cursorDisplay || "_", a.innerHTML = this.cursorDisplay, this.on = !0, a.style.transition = "all 0.1s", this.interval = setInterval(() => this.updateBlinkState(), 400)
};
